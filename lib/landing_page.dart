...
class LandingPage extends StatelessWidget {
  ...
  String get _logoSvg {
    final red = logoColor.red.toRadixString(16).padLeft(2, '0');
    final green = logoColor.green.toRadixString(16).padLeft(2, '0');
    final blue = logoColor.blue.toRadixString(16).padLeft(2, '0');
